...
function OnShowVideoSettings()
{
  ...
  wnd.title = "##screen_settings##";
	...
	var btnSwitchMode = wnd.addButton( 50, 45, wnd.width-50, 20 );
  ...
  var lbxModes = wnd.addListBox( 52, 68, wnd.width-50, 160 );
  ...
  for( var i=0; i < g_session.videoModesCount; i++ )
  {
    ...
    var index = lbxModes.addItem( mode.w+"x"+mode.h );
	  lbxModes.setItemData( index, "mode", (mode.w << 16) + mode.h );
    lbxModes.setTextAlignment( "center", "center" );
  }
	
	var resolution = { w:0, h:0 };
	resolution.w = g_session.getResoltionW();
	resolution.h = g_session.getResoltionH();
   
  var btnOk = wnd.addButton( 50, 237, wnd.width-50, 20 );
