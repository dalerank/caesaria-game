...
lobby.ui.newgame.startCareer = function () {
    lobby.ui.changePlayerName(true, function () {
        g_session.setMode(0);
    });
}
...
lobby.ui.newgame.showpage = function () {
    ...
    lobby.ui.addButton("##mainmenu_startcareer##", function () {
        lobby.ui.newgame.startCareer()
    })
    lobby.ui.addButton("##mainmenu_randommap##", function () {
        lobby.ui.newgame.playRandom()
    })
    lobby.ui.addButton("##mainmenu_constructor##", function () {
        lobby.ui.newgame.openConstructor()
    })
...
lobby.ui.changePlayerName = function (force, continueCallback) {
    ...
    if (playerName.length === 0 || force) {
        ...
        editbox.onTextChangeCallback = function (text) {
            engine.setOption("playerName", text);
        }
...
lobby.ui.addButton = function (caption, callback) {
    ...
    var offset = {
        x: (resolution.w - buttonSize.w) / 2,
        y: (resolution.h - offsetY * lobby.ui.buttons.length) / 2
    };
...
lobby.ui.loadgame.showpage = function () {
    ...
    lobby.ui.addButton("##mainmenu_playmission##", function () {
        lobby.ui.loadgame.loadmission()
    })
    lobby.ui.addButton("##mainmenu_loadgame##", function () {
        lobby.ui.loadgame.loadsave()
    })
    lobby.ui.addButton("##mainmenu_loadmap##", function () {
        lobby.ui.loadgame.loadmap()
    })
    lobby.ui.addButton("##cancel##", function () {
        lobby.ui.mainmenu.showpage()
    })
...
lobby.ui.options.showpage = function () {
    ...
    lobby.ui.addButton("##mainmenu_language##", function () {
        lobby.ui.options.showLanguageSettings()
    })
    lobby.ui.addButton("##mainmenu_video##", function () {
        game.ui.dialogs.showVideoOptions()
    })
    lobby.ui.addButton("##mainmenu_sound##", function () {
        game.ui.dialogs.showAudioOptions()
    })
    lobby.ui.addButton("##mainmenu_package##", function () {
        lobby.ui.dialogs.showPackageOptions()
    })
    lobby.ui.addButton("##mainmenu_plname##", function () {
        lobby.ui.changePlayerName(true)
    })
    lobby.ui.addButton("##mainmenu_showlog##", function () {
        lobby.ui.showLogs()
    })
    lobby.ui.addButton("##mainmenu_changes##", function () {
        lobby.ui.showChanges(true)
    })
    lobby.ui.addButton("##cancel##", function () {
        lobby.ui.mainmenu.showpage()
    })
...
lobby.ui.mainmenu.showpage = function () {
    ...
    if (lastGame && lastGame.length > 0)
        lobby.ui.addButton("##mainmenu_continueplay##", function () {
            lobby.ui.continuePlay()
        })

    lobby.ui.addButton("##mainmenu_newgame##", function () {
        lobby.ui.newgame.showpage()
    })
    lobby.ui.addButton("##mainmenu_load##", function () {
        lobby.ui.loadgame.showpage()
    })
    lobby.ui.addButton("##mainmenu_options##", function () {
        lobby.ui.options.showpage()
    })
    lobby.ui.addButton("##mainmenu_credits##", function () {
    ...
    lobby.ui.addButton("##mainmenu_quit##", function () {
        g_session.setMode(g_config.lobby.res_close);
    });
}
...
lobby.start = function () {
    ...
    btnHomePage.callback = function () {
        g_session.openUrl("http://www.caesaria.net");
    }
    btnHomePage.tooltip = "Open website in browser";

    var btnSteamPage = new TexturedButton(0);
    btnSteamPage.geometry = {
        x: startx + 64,
        y: screen.h - 70,
        w: 64,
        h: 64
    ...
    btnSteamPage.callback = function () {
        g_session.openUrl("http://store.steampowered.com/app/327640");
    }
    ...
    btnIrcPage.callback = function () {
        g_session.openUrl("http://webchat.quakenet.org/?channels=caesaria");
    }
    btnIrcPage.tooltip = "Open developer's chat in browser";

    var btnReportBugPage = new TexturedButton(0);
    btnReportBugPage.geometry = {
        x: startx + 64 * 3,
        y: screen.h - 70,
        w: 64,
        h: 64
    };
    btnReportBugPage.states = {
        rc: "breport",
        normal: 1,
        hover: 2,
        pressed: 2,
    ...
    btnReportBugPage.callback = function () {
        g_session.openUrl("https://bitbucket.org/dalerank/caesaria/issues/new");
    }
    btnReportBugPage.tooltip = "Report about bug";

    var btnTranslationPage = new TexturedButton(0);
    btnTranslationPage.geometry = {
        x: startx + 64 * 4,
        y: screen.h - 70,
        w: 64,
        h: 64
    };
    btnTranslationPage.states = {
        rc: "translation",
        normal: 1,
        hover: 2,
        pressed: 2,
    ...
    btnTranslationPage.callback = function () {
        g_session.openUrl("https://docs.google.com/spreadsheets/d/1vpV9B6GLUX5G5z3ftucBFl7pXr-I0QvHPI9vW6K4xlY");
    }
