...
sim.ui.menu.simConfig = {
    ...
    reorient_map_to_north: {
        ...
        pushButton: false,
        submenu: false,
        sound: "reorient_map_to_north"
    },

    rotate_map_counter_clockwise: {
        pos: {
            x: 84,
            y: 184
        },
        ...
        object: "rotate_map_counter_clockwise",
        miniature: {
            rc: "panelwindows",
            index: 12
        },
        pushButton: false,
        submenu: false,
        sound: "rotate_map_counter_clockwise"
    },
...
sim.ui.menu.simConfig.minimize.func = function () {
    ...
    sim.ui.buildmenu.hide();
    var stopPos = {
        x: menu.x + menu.w * (sim.ui.menu.rightSide ? 1 : -1),
        y: menu.y
    };
...
sim.ui.menu.simConfig.senate.func = function () {
    g_session.setOption("advisor", g_config.advisor.employers);
}
sim.ui.menu.simConfig.empire.func = function () {
    g_session.setOption("showEmpireMap", true);
}
sim.ui.menu.simConfig.mission.func = function () {
...
sim.ui.menu.initialize = function () {
    ...
    menu.geometry = {
        x: resolution.w - bgbody.w - rbody.w,
        y: topmenu.h,
        w: bgbody.w,
        h: resolution.h
    };
    ...
    for (var i in sim.ui.menu.config) {
        ...
        btn.states = {
            rc: config.image.rc,
            normal: config.image.index,
            hover: config.image.index + 1,
            pressed: config.image.index + 2,
            disabled: config.image.index + 3
        };
        btn.fitToImage();
        ...
        (function (c, y) {
            ...
            else sim.ui.menu.funcs[i] = function () {
                sim.ui.menu.showbuildmenu(c, y);
            }
        })(config, btn.screeny);
    ...
    g_session.camera.onLocationChanged = function (p) {
        menu.minimap.tileCenter = p;
    }
