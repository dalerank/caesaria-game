...
PACKAGE_NAME_MACOS=caesaria_nightly_linux_$REVISION_NUMBER.zip
zip -r $PACKAGE_NAME_LINUX resources README.md caesaria.macos
...
sshpass -p $SF_PASSWORD scp caesaria.macos caesaria.updater dalerank@frs.sourceforge.net:/home/frs/project/opencaesar3/stuff/
