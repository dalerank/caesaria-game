...
BuildingDataHolder::BuildingDataHolder()
{
   ...
   //_mapBuildingByService[S_TEMPLE_NEPTUNE] = B_;
   //_mapBuildingByService[S_TEMPLE_CERES] = B_;
   //_mapBuildingByService[S_TEMPLE_VENUS] = B_;
   //_mapBuildingByService[S_TEMPLE_MARS] = B_;
   //_mapBuildingByService[S_TEMPLE_MERCURE] = B_;
