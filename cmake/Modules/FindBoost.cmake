...
set(Boost_ERROR_REASON)
  ...
  if( NOT Boost_INCLUDE_DIR )
    ...
    find_path(Boost_INCLUDE_DIR
      ...
      HINTS         ${CMAKE_CURRENT_SOURCE_DIR}/dependencies/boost ${_boost_INCLUDE_SEARCH_DIRS}
  ...
  foreach(COMPONENT ${Boost_FIND_COMPONENTS})
	...
	find_library(Boost_${UPPERCOMPONENT}_LIBRARY_RELEASE
        ...
        HINTS ${CMAKE_CURRENT_SOURCE_DIR}/dependencies/boost ${_boost_LIBRARY_SEARCH_DIRS} 
        ${_boost_FIND_OPTIONS}
		PATH_SUFFIXES lib
