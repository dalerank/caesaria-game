...
enum ServiceType { S_WELL, S_FOUNTAIN, S_MARKET, S_ENGINEER, S_SENATE, S_FORUM, S_PREFECT, S_TEMPLE_NEPTUNE, S_TEMPLE_CERES, S_TEMPLE_VENUS, S_TEMPLE_MARS, S_TEMPLE_MERCURE, S_DOCTOR, S_BARBER, S_BATHS, S_HOSPITAL, S_SCHOOL, S_LIBRARY, S_COLLEGE, S_THEATER, S_AMPHITHEATER, S_COLLOSSEUM, S_HIPPODROME, S_MAX };
...
enum BuildMenuType { BM_NONE, BM_WATER, BM_HEALTH, BM_SECURITY, BM_EDUCATION, BM_ENGINEERING, BM_ADMINISTRATION, BM_ENTERTAINMENT, BM_COMMERCE, BM_FARM, BM_RAW_MATERIAL, BM_FACTORY, BM_TEMPLE, BM_MAX };
