...
enum GoodType { G_NONE, G_WHEAT, G_FISH, G_MEAT, G_FRUIT, G_VEGETABLE, G_OLIVE, G_OIL, G_GRAPE, G_WINE, G_TIMBER, G_FURNITURE, G_CLAY, G_POTTERY, G_IRON, G_WEAPON, G_MARBLE, G_SCARB1, G_SCARB2, G_MAX };
