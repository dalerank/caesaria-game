...
{
  addCreator( B_ROAD,     OC3_STR_EXT(B_ROAD), new CitizenInfoboxCreator<InfoBoxLand>() );
  ...
  addCreator( B_PLAZA,   OC3_STR_EXT(B_PLAZA), new CitizenInfoboxCreator<InfoBoxLand>() );
  addCreator( B_NONE,    OC3_STR_EXT(B_NONE), new CitizenInfoboxCreator<InfoBoxLand>() );
  ...
  addCreator( B_COLLOSSEUM,    OC3_STR_EXT(B_COLLOSSEUM), new BaseInfoboxCreator<InfoBoxColosseum>() );
