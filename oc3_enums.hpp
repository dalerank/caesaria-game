...
enum WalkerGraphicType { WG_NONE, WG_POOR, WG_BATH, WG_PRIEST, WG_ACTOR, WG_TAMER, WG_TAX, WG_CHILD, WG_MARKETLADY, WG_PUSHER,
  WG_PUSHER2, WG_ENGINEER, WG_GLADIATOR, WG_GLADIATOR2, WG_RIOTER, WG_BARBER, WG_PREFECT, WG_HOMELESS, WG_RICH, WG_RICH2,
  WG_DOCTOR, WG_LIBRARIAN, WG_JAVELINEER, WG_SOLDIER, WG_HORSEMAN, WG_HORSE_CARAVAN, WG_CAMEL_CARAVAN, WG_LITTLE_HELPER, WG_MAX };

enum WalkerType { WT_NONE, WT_IMMIGRANT, WT_EMIGRANT, WT_SOLDIER, WT_CART_PUSHER, WT_MARKET_BUYER, WT_SERVICE, WT_TRAINEE, WT_MAX, WT_ALL=WT_MAX };

enum GoodType { G_NONE, G_WHEAT, G_FISH, G_MEAT, G_FRUIT, G_VEGETABLE, G_OLIVE, G_OIL, G_GRAPE, G_WINE,
  G_TIMBER, G_FURNITURE, G_CLAY, G_POTTERY, G_IRON, G_WEAPON, G_MARBLE, G_MAX };
...
enum ServiceType { S_WELL, S_FOUNTAIN, S_MARKET, S_ENGINEER, S_SENATE, S_FORUM, S_PREFECT, S_TEMPLE_NEPTUNE, S_TEMPLE_CERES, S_TEMPLE_VENUS,
  ...
  S_THEATER, S_AMPHITHEATER, S_COLLOSSEUM, S_HIPPODROME, S_BURNING_RUINS, S_COLLAPSED_RUINS, S_WORKERS_HUNTER, S_MAX };
...
enum BuildingType
{
   ...
   B_TRIUMPHAL_ARCH, B_BURNING_RUINS, B_COLLAPSED_RUINS,
   B_MAX
};
