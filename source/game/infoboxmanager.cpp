...
InfoBoxManager::InfoBoxManager() : _d( new Impl )
{
  ...
  addInfobox( building::doctor,         OC3_STR_EXT(Doctor),      new ServiceBaseInfoboxCreator( "##doctor_title##", "##doctor_text##" ) );
  addInfobox( building::baths,          OC3_STR_EXT(Baths),       new ServiceBaseInfoboxCreator( "##baths_title##", "##baths_text##" ) );
  addInfobox( building::barber,         OC3_STR_EXT(Barber),      new ServiceBaseInfoboxCreator( "##barber_title##", "##barber_text##" ) );
  addInfobox( building::hospital,       OC3_STR_EXT(B_HOSPITAL),  new ServiceBaseInfoboxCreator( "##hospital_title##", "##hospital_text##" ) );
  ...
  addInfobox( building::school,         OC3_STR_EXT(B_SCHOOL),    new ServiceBaseInfoboxCreator( _("##school_title##"), _("##school_text##") ));
  addInfobox( building::academy,        OC3_STR_EXT(B_COLLEGE),   new ServiceBaseInfoboxCreator( _("##college_title##"), _("##college_text##") ));
  addInfobox( building::library,        OC3_STR_EXT(B_LIBRARY),   new ServiceBaseInfoboxCreator( _("##library_title##"), _("##library_text##") ));
  addInfobox( construction::garden,       OC3_STR_EXT(B_GARDEN),    new InfoBoxBasicCreator( _("##building_garden##"), _("##garden_desc##")) );
  addInfobox( building::smallStatue,        OC3_STR_EXT(B_STATUE1),   new InfoBoxBasicCreator( _("##building_statue_small##"), _("##statue_desc##")) );
  addInfobox( building::middleStatue,        OC3_STR_EXT(B_STATUE2),   new InfoBoxBasicCreator( _("##building_statue_middle##"), _("##statue_desc##")) );
  addInfobox( building::bigStatue,        OC3_STR_EXT(B_STATUE3),   new InfoBoxBasicCreator( _("##building_statue_big##"), _("##statue_desc##")) );
  ...
  addInfobox( building::weaponsWorkshop, OC3_STR_EXT(B_WEAPONS_WORKSHOP), new BaseInfoboxCreator<GuiInfoFactory>() );
  addInfobox( building::furnitureWorkshop,        OC3_STR_EXT(B_FURNITURE), new BaseInfoboxCreator<GuiInfoFactory>() );
