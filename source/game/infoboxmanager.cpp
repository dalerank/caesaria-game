...
InfoBoxManager::InfoBoxManager( CityPtr city, GuiEnv* gui ) : _d( new Impl )
{
  ...
  addInfobox( buildingTheater,          OC3_STR_EXT(buildingTheater), new ServiceBaseInfoboxCreator( _("##theater_title##"), _("##theater_text##")) );
  ...
  addInfobox( B_WHARF,            OC3_STR_EXT(B_WHARF), new BaseInfoboxCreator<GuiInfoFactory>() );
}
