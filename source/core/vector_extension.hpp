...
public:
  ...
  void erase(iterator b, iterator e) { _data.erase(b, e); }
  iterator begin() { return _data.begin(); }
  iterator end() { return _data.end(); }
  const_iterator end() const { return _data.end(); }
  size_t size() const { return _data.size(); }
  void resize(size_t newSize) { _data.resize(newSize); }
  void resize(size_t newSize, const T& def) { _data.resize(newSize, def); }
  ...
  void insert(iterator it, const T& value) { _data.insert(it, value); }
