...
#define PREFEDINE_NS_CLASS_SMARTPOINTER_LIST(ns,a,b) PREFEDINE_NS_CLASS_SMARTPOINTER(ns,a); typedef std::list< ns::a##Ptr > a##b;
...
PREFEDINE_CLASS_SMARTPOINTER_LIST(Wharf,List)
PREFEDINE_CLASS_SMARTPOINTER_LIST(FishPlace,List)
PREFEDINE_CLASS_SMARTPOINTER_LIST(FishingBoat,List)
PREFEDINE_CLASS_SMARTPOINTER_LIST(Hippodrome,List)
PREFEDINE_CLASS_SMARTPOINTER_LIST(Ability,List)
PREFEDINE_CLASS_SMARTPOINTER_LIST(Protestor,List)
...
PREFEDINE_CLASS_SMARTPOINTER(MarketKid)
...
PREFEDINE_CLASS_SMARTPOINTER(Prefect)
