...
void Propagator::setObsoleteOverlay( Overlay::Type type){ _d->obsoleteOvs.insert( type ); }
...
DirectPRoutes Propagator::getRoutes(const Overlay::Type buildingType)
{
  DirectPRoutes ret;
...
DirectRoute Propagator::getShortestRoute(const Overlay::Type buildingType )
{
