...
public:  
  ...
  virtual const constants::walker::VisibleWalkers& visibleWalkers() const;
...
protected:
  ...
  WalkerList _getVisibleWalkerList( const constants::walker::VisibleWalkers& aw, const TilePos& pos );
