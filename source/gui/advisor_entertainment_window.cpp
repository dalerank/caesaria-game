...
public:
  EntertainmentInfoLabel( Widget* parent, const Rect& rect,
                          const constants::objects::Type service, InfrastructureInfo info  )
    : Label( parent, rect ),
      _service( service ),
      _info( info )
  {    
...
public:
  ...
  InfrastructureInfo getInfo(const constants::objects::Type service );
  void updateInfo();
...
InfrastructureInfo Entertainment::Impl::getInfo( const constants::objects::Type service)
{
